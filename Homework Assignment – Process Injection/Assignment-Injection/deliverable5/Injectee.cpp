...
public:
	...
	private:
    void disappearEnemy(){
        // Parameters to modify memory value that records the number of enemies on screen
        numBytes = 4;
        char disap_cheat_Instr[4] = {'\x00', '\x00', '\x00', '\x00'};
        DWORD disap_cheat_InstrAddress = 0x00AFE13C;
        overwriteMemory(disap_cheat_InstrAddress, disap_cheat_Instr, numBytes);
    }
